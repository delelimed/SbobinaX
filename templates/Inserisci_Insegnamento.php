...
if (isset($_SESSION['id']) && isset($_SESSION['nome']) && $_SESSION['admin'] == 1 && $_SESSION['locked'] == 0){
    ...
    <head>
        ...
        <title>SbobinaX | Inserisci Insegnamento</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Nuovo Insegnamento</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="../req/register_insegnamento.php" method="post">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" >Aggiungi Insegnamento</button>
                            </div>
                        </form>
                    </div>
                </div><!-- /.container-fluid -->
