...
if (isset($_SESSION['id']) && isset($_SESSION['nome']) && $_SESSION['admin'] == 1 && $_SESSION['locked'] == 0){
    ...
    <head>
        ...
        <title>SbobinaX | Vedi Insegnamenti</title>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <button type="button" class="btn btn-primary" onclick="window.location.href='./Inserisci_Insegnamento.php'">Nuovo Insegnamento</button>
